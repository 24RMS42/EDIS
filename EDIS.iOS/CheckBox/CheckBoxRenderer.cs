...
using EDIS.iOS.Extensions;
using UIKit;
using Xamarin.Forms.Platform.iOS;

namespace EDIS.iOS.CheckBox
{
    /// <summary>
    /// The check box renderer for iOS.
    /// </summary>
    public class CheckBoxRenderer : ViewRenderer<EDIS.Shared.Controls.CheckBox, CheckBoxView>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<EDIS.Shared.Controls.CheckBox> e)
        {
